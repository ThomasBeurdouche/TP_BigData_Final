...
hadoop jar /tmp/jars/tpfinal-thomas_beurdouche_job1.jar /data/relationships/data.txt /data/outputJob1/
hadoop jar /tmp/jars/tpfinal-thomas_beurdouche_job2.jar /data/outputJob1/ /data/outputJob2/
hadoop jar /tmp/jars/tpfinal-thomas_beurdouche_job3.jar /data/outputJob2/ /data/outputJob3/
